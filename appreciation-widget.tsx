      ...
      <CardContent className="p-6">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-slate-600 dark:text-slate-400">
            // Thanks for checking out my work! Let's exchange some good vibes 🤝
          </p>
        </div>
            ...
            >
              <Icon 
                className={`mr-2 transition-all duration-300 ${
                  selectedIcon === label ? `${color} animate-bounce` : 'text-slate-600 dark:text-slate-400'
                }`} 
                size={16} 
              />
        ...
        <div className="min-h-[80px] flex items-center justify-center">
          {currentMessage ? (
            <div className={`text-center p-4 rounded-lg bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 border border-blue-200 dark:border-blue-700 transition-all duration-500 ${
